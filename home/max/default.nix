...
{ lib, pkgs, ... }:
{
  ...
  # The launcher both compositor configs spawn, and the clipboard tools. The
  # terminal they spawn is in ./ghostty.nix; everything else installed for this
  # user is in ./dev.nix, ./apps.nix or ./git.nix.
  #
